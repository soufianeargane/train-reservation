        ...
        <div class="w-full space-y-5 px-10 my-20 md:my-auto">
            <form action="" method="post" data-parsley-validate>
                ...
                <div>
                    ...
                    <input type="text" name="nameAccount" id="" value="Saad Meddiche" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Name ..." required>
                </div>
                <div>
                    <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Email</label>
                    <input type="text" name="emailAccount" id="" value="saadMeddiche2004201@gmail.com" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Email ..." required>
                </div>
                ...
                <div class="AfterMod hidden">
                    ...
                    <input type="text" name="passwordMOD" id="" value="" class="clear bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Current Password ..." data-parsley-minlength="8" data-parsley-minlength-message="Please set a password more then 8" data-parsley-equalto="#samepass2" data-parsley-equalto-message="This is not the same password" required>
                </div>
                <div class="AfterMod hidden">
                    <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">New Password</label>
                    <input type="text" name="passwordMOD" id="samepass" value="" class="clear bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="New Password ..." data-parsley-minlength="8" data-parsley-minlength-message="Please set a password more then 8" required>
                </div>
                <div class="AfterMod hidden">
                    <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black"> Repeat Password</label>
                    <input type="text" name="passwordMOD" id="" value="" class="clear bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Repeat Password ..." data-parsley-equalto="#samepass" data-parsley-equalto-message="This is not the same password" data-parsley-minlength="8" data-parsley-minlength-message="Please set a password more then 8"  required>
                </div>
                <!-- end -->
                <div class="AfterMod">
                    <label for="text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Password</label>
                    <input type="text" name="passwordMOD" id="samepass2" value="**********" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Password ..." required>
                </div>
                <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <button type ="submit" class="AfterMod hidden  bg-gray-50 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white w-2/3"><b>Update</b></button>
                    </div>
                </div>
            </form>
